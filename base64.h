...
static size_t Base64encode_len(size_t _NunOfBytesToEncode)
{
...
static size_t Base64Decode_nprbytes(const char* bufcoded, size_t len)
{
    size_t nprbytes;
...
static size_t Base64decode_len(size_t nprbytes)
{
...
*/
static size_t Base64encode(char* _Encoded, const void* _ToEncode, size_t _NunOfBytesToEncode)
{
...
*/
static size_t Base64decode(char* _Decoded, const char* _ToDecode, size_t _NunOfBytesToDecode)
{
...
*   Returns the size of _Encoded
*/
static size_t Base64encode_BigEndian(char* _Encoded, const void* _ToEncode, size_t _NunOfBytesToEncode) {
