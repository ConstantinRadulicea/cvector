...
void imu_update_gyro(imu_t* im, coord3D imu_raw_gyro_rad) {
	...
	im->filtered_gyro.x = pt1_filter_apply(&(im->gyro_pt1_filter_x), imu_raw_gyro_rad.x);
	im->filtered_gyro.y = pt1_filter_apply(&(im->gyro_pt1_filter_y), imu_raw_gyro_rad.y);
	im->filtered_gyro.z = pt1_filter_apply(&(im->gyro_pt1_filter_z), imu_raw_gyro_rad.z);
...
void imu_update_accel(imu_t* im, coord3D imu_raw_accel_m_s2) {
	...
	im->filtered_accel.x = pt1_filter_apply(&(im->accel_pt1_filter_x), imu_raw_accel_m_s2.x);
	im->filtered_accel.y = pt1_filter_apply(&(im->accel_pt1_filter_y), imu_raw_accel_m_s2.y);
	im->filtered_accel.z = pt1_filter_apply(&(im->accel_pt1_filter_z), imu_raw_accel_m_s2.z);
